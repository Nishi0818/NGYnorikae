...
export default function HomeScreen() {
  ...
  const revisionDates = Array.from(new Set(SUBWAY_LINES.map((line) => TIMETABLE_REVISIONS[line.id]))).join(" · ");
